...
// efeito. Hoje só Chuva; novos efeitos entram só com mais um caso no mapa abaixo.

import type { WeatherEffectKind } from '../../data/cityWeather.ts'
import styles from './WeatherBadge.module.css'

const WEATHER_ICON: Record<WeatherEffectKind, string> = {
  rain: '🌧️',
}

const WEATHER_LABEL: Record<WeatherEffectKind, string> = {
  rain: 'Chovendo',
}
